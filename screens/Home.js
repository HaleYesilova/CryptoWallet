...
const Home = ({ navigation }) => {
    ...
    const [trending, setTrending] = React.useState(dummyData.
        trendingCurrencies)  
            ...
            >
                ...
                >
                    ...
                    >
                        ...
                        color: COLORS.white, ...FONTS.h2 }}>Trending</Text>
                        <FlatList
        ...
        return (
            ...
            >
                ...
                <Text style={{ marginTop: SIZES.base, color: COLORS.white, ...FONTS.body4, lineheight:18 }}>It's very difficult to time an investment,
                    ...
                    dollar cost averaging to your advantage.</Text>
                    ...
                    <TouchableOpacity
                        ...
                        color: COLORS.green, ...FONTS.h3 }}>Learn More</
                        Text>
